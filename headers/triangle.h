...
public:
  ...
  unsigned int ghost_cell(unsigned int num) const;
            ...
            /**
             * Set the list of the ghost cells
             * @param g_cells - new list
             */
  void ghost_cells(const std::vector<unsigned int> &g_cells);
  ...
  bool contains_dof(unsigned int num) const;
            ...
            /**
             * Check whether this triangle has this specific vertex
             * @param num - the number of the vertex
             */
  bool contains_vertex(unsigned int num) const;
